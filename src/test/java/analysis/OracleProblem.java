...
public class OracleProblem {
        ...
        for (final Map.Entry<String, Map<String, Map<String, String>>> m1 : allPossibleResults.entrySet()) {
            for (final Map.Entry<String, Map<String, String>> m2 : m1.getValue().entrySet()) {
                for (final Map.Entry<String, String> m3 : m2.getValue().entrySet()) {
                    ...
                    loop:
                    for (int a = MIN_VALUE + 1; a < MAX_VALUE; a++) {
    ...
    boolean isNormalTriangle(int a, int b, int c) {
        if ((a < (b + c)) && (b < (a + c)) && (c < (a + b))) {
            if (a == b && b == c) {
                return true;
            } else if (a != b && a != c && b != c) {
    ...
    boolean isNormalRectangle(int a, int b, int c, int d) {
        if (a == b && c == d) {
            if (a != c) {
                return true;
            } else
    ...
    public String classify3Parameters(int a, int b, int c) {
    ...
    public String classify2Parameters(int a, int b) {
        if (a == b) {
            return "Circle";
        } else if (a == 0) {
            if (b > 0) {
    ...
    // Classify four sides
    public String classify4Parameters(int a, int b, int c, int d) {
        if (a == b && c == d) {
            if (a != c) {
                return "Rectangle";
            } else
