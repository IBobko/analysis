...
public class ShapeClassifierTest {
    ...
    private static final Integer MAX_VALUE = 300;
    private Map<String,Map<String,Map<String,String>>> allPossibleResults = new HashMap<>();
    ...
    private void printResultWeMustGet() {
